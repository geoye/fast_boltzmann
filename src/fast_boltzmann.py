...
class BoltzNumerical:
    """
    Fast implementation of the Boltzmann Entropy calculation of a 2-D numerical data array.
...
class BoltzNominal:
    """
    Fast implementation of the Boltzmann Entropy calculation of a 2-D nominal data array.
